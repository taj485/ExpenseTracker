...
export const routes: Routes = [
  { path: '', component: HomeComponent },
  {
    ...
    children: [
      ...
      { path: 'expenses/table/:tableId',                    component: ExpenseListComponent },
      { path: 'expenses/table/:tableId/receipt/:receiptId', component: ReceiptGroupComponent },
      { path: 'expenses/table/:tableId/:id/edit',           component: ExpenseEditComponent },
      { path: 'expenses/table/:tableId/:id',                component: ExpenseDetailComponent },
    ],
  },
  { path: '**', redirectTo: '' },
];
