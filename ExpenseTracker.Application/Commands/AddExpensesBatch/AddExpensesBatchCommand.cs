...
{
    public record AddExpensesBatchCommand(int ExpenseTableId, List<AddExpenseCommand> Items, string? ReceiptImageReference = null) : IRequest<AddExpensesBatchResult>;
